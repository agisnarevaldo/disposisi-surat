...
export default function TugasSayaIndex({ auth, suratMasuk, flash }: TugasSayaIndexProps) {
    const [searchTerm, setSearchTerm] = useState('');
    const [statusFilter, setStatusFilter] = useState('all');

    const breadcrumbs = [
        { title: 'Dashboard', name: 'Dashboard', href: route('dashboard') },
        { title: 'Tugas Saya', name: 'Tugas Saya', href: route('tugas-saya.index'), current: true }
    ];
            ...
            <div className="container mx-auto p-4">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-gray-600">Daftar tugas disposisi surat yang diberikan kepada Anda</p>
                    </div>
                </div>
                                    ...
                                    >
                                        <div className="flex items-start justify-between">
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-600">
                                                    ...
                                                    {surat.kepala && (
                                                        <div className="flex items-center gap-2">
                                                            <User className="w-4 h-4" />
                                                            <span>Dari Kepala: {surat.kepala.name}</span>
                                                        </div>
                                                    )}
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex items-center gap-2 ml-4">
                                                <Link href={route('tugas-saya.show', surat.id)}>
